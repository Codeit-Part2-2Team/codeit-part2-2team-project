...
**이상 신호 확인 후 DE (소원)에게 요청할 질문:**
1. train/val/test split이 원본 이미지 기준으로 먼저 나뉜 뒤 train에만 증강됐나요?
2. val/test에도 증강 이미지가 포함되어 있나요?
3. rare class별 원본 수 / train / val / test 분포 확인 가능할까요?

> 0429 오후 3:00(조퇴) PM (호정) 현재 부재 중이므로 이상 신호 확인 시 PM 복귀 후 보고 원칙 유지
